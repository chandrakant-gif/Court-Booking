...
const Sidebar = () => {
  ...
  const sidebarLinks = [
    ...
    { name: 'Add Court', path: '/owner/add-court',  icon: assets.addIcon },
    { name: 'List Courts', path: '/owner/list-courts', icon: assets.listIcon }, 
  ];
  return (
    <div className='md:w-64 mt-10 w-16 border-r h-full text-base border-gray-300 pt-4 flex flex-col transition-all duration-300 '>
